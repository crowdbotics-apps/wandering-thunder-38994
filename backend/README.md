...
## Project Structure
    ...
    ├── wandering_thunder_38994  # Django project configurations
...
1. Clone this repo and `cd wandering_thunder_38994`
...
2. Clone this repo and `cd wandering_thunder_38994`
